from performance_tests.dijkstra_performance_test import DijkstraPerformance
from performance_tests.ida_star_performance_test import IdaStarPerformance
from performance_tests.heap_performance_test import HeapPerformance
...
class PerformanceTest():
    ...
    def test_performance_plot(self, current_map):
        ...
        for y in range(map_length):
            for x in range(map_length):
                if InputCheck().check_input(current_map=current_map, x_start=0,
                                            y_start=0, x_end=x, y_end=y):
                    ...
                    ida_star_result = IdaStar(current_map).find_route(
                        start_x=0, start_y=0, end_x=x, end_y=y)
                    # If path is found, the distance is added to
                    # handled distances and to the algorithm's results
                    if dijkstra_result:
    ...
    def test_heap_performance(self):
        ...
        """
        own_heap_time = HeapPerformance().test_own_heap_push_and_pop_1000_times()
        python_heap_time = HeapPerformance().test_python_heap_push_and_pop_1000_times()
        print(f"""My heap did 1000 push and pop functions in {own_heap_time.microseconds} microseconds.
            Python's heapq did the same in
            {python_heap_time.microseconds} microseconds.""")
    ...
    def test_performance_10x10_map(self):
        ...
        """
        dijkstra_time = DijkstraPerformance().test_dijkstra_100_times_10x10_map()
        ida_star_time = IdaStarPerformance().test_ida_star_100_times_10x10_map()
        print(
        ...
        if dijkstra_time > ida_star_time:
            ...
            print(
                f"""IDA* star was faster by {difference_time.microseconds}microseconds,
                 {difference_percentage} %""")
            return ("IDA*", difference_time.microseconds, difference_percentage)
        difference_percentage = round(
            (difference_time / ida_star_time * 100), 2)
        print(""
              f"""Dijkstra star was faster by {difference_time.microseconds}
            microseconds, {difference_percentage}""")
    ...
    def test_performance_15x15_map(self):
        ...
        After testing, the time difference is counted.
        """
        dijkstra_time = DijkstraPerformance().test_dijkstra_100_times_15x15_map()
        ida_star_time = IdaStarPerformance().test_ida_star_100_times_15x15_map()
        print(
            f"""Dijkstra found 100 routes in 15x15 map in
            {dijkstra_time.microseconds} microseconds""")
        print(
            f"""IDA* found 100 routes in 15x15 map in
            {ida_star_time.microseconds} microseconds""")
        difference_time = abs(dijkstra_time - ida_star_time)
        if dijkstra_time > ida_star_time:
            difference_percentage = round(
                (difference_time / dijkstra_time * 100), 2)
            print(
                f"""IDA* star was faster by {difference_time.microseconds}
                microseconds, {difference_percentage} %""")
            return ("IDA*", difference_time.microseconds, difference_percentage)
        difference_percentage = round(
            (difference_time / ida_star_time * 100), 2)
    ...
    def test_performance_30x30_map(self):
        ...
        After testing, the time difference is counted.
        """
        dijkstra_time = DijkstraPerformance().test_dijkstra_100_times_30x30_map()
        ida_star_time = IdaStarPerformance().test_ida_star_100_times_30x30_map()
        print(
            f"""Dijkstra found 100 routes in 30x30 map in
            {dijkstra_time.microseconds} microseconds""")
        print(
            f"""IDA* found 100 routes in 30x30 map in
            {ida_star_time.microseconds} microseconds""")
        difference_time = abs(dijkstra_time - ida_star_time)
        if dijkstra_time > ida_star_time:
            difference_percentage = round(
    ...
    def test_performance_50x50_map(self):
        ...
        After testing, the time difference is counted.
        """
        dijkstra_time = DijkstraPerformance().test_dijkstra_10_times_50x50_map()
        ida_star_time = IdaStarPerformance().test_ida_star_10_times_50x50_map()
        print(
            f"""Dijkstra found 100 routes in 50x50 map in
            {dijkstra_time.microseconds} microseconds""")
        print(
            f"""IDA* found 100 routes in 50x50 map in
            {ida_star_time.microseconds} microseconds""")
        difference_time = abs(dijkstra_time - ida_star_time)
        if dijkstra_time > ida_star_time:
            difference_percentage = round(
